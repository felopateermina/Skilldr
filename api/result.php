...
$products = [
  ...
  [
      'name' => 'mysql mysql tutorials mysql examples mysql database mysql queries mysql syntax mysql commands mysql joins mysql stored procedures mysql indexing mysql optimization mysql performance tuning mysql backup mysql restore mysql replication mysql clustering mysql security mysql workbench mysql php mysql node.js mysql java mysql python mysql connection mysql database design mysql normalization mysql foreign keys mysql constraints mysql triggers mysql functions mysql transactions mysql optimization techniques mysql performance tuning mysql security best practices mysql data replication mysql high availability mysql backup and recovery',
  ...
  [
      'name' => 'my account password my account password my account pin my account management email e-mail account settings of my account password password changing password reset account management email settings two-factor authentication security settings',
